(defproject algorithms-clj "0.1.0-SNAPSHOT"
  ...
  :uberjar-name "algorithms-clj.jar"

  ;; Use `lein run` if you just want to start a HTTP server, without figwheel
  :main algorithms-clj.server
  ...
  :cljsbuild {:builds
              [{:id "app"
                ...
                ;; :figwheel {:on-jsload "algorithms-clj.core/on-figwheel-reload"}

                :compiler {:main algorithms-clj.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/algorithms_clj.js"
               ...
               {:id "test"
                ...
                :compiler {:output-to "resources/public/js/compiled/testable.js"
                           :main algorithms-clj.test-runner
                           :optimizations :none}}
